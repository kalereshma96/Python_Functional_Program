...
"""
purpose   :Takes year and day as input and
           print the calender for all months
           in that year. 
...
startday=input('Enter start day of the year : Mo,Tu,We,Th,Fr,Sa,Su')
make_calendar(year,startday)
