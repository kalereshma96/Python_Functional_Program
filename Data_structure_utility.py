...
############################################################################
class Data_structure_utility:
    def palindrome(self):
        flag = 0
        str = (input("Enter String.."))
        for i in range(0, len(str)):
           str1 = str[i]
           Data_structure_utility.addRear(str1)
           while (Data_structure_utility.size() > 1):
            if (Data_structure_utility.removeFront() != Data_structure_utility.removeRear()):
                flag = 1
                break
